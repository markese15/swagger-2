...
public class ArithmeticOperation {
    @ApiModelProperty(value = " arithmetic operation", example = "Addition")
    private String name;
    @ApiModelProperty(value = "Minimum number of operands ", example = "2")
    private int minNumberOfOperands;
    @ApiModelProperty(value = "The description ", example = "addend + addend = sum")
    private String description;
    @ApiModelProperty(value = "A list of properties ", example = "['Anti-commutativity', 'Non-associativity', 'Predecessor']")
